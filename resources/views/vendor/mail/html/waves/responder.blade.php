                ...
                <table>
                    <tr>
                        <td> --}}
                            ...
                            <p class="lead">You’ve been added as a Responder to your school’s Waves Network and have been given access to the Waves App. Having access to the Waves App allows you to be more accessible to your assigned students, makes your job easier, and creates a streamline form of communication between students and the support services offered by your school. To access the Waves App, you will log in using the following information:

                            </p>

                            {{-- <p class="lead">Before jumping into the Waves App, here are a few things to know. To access the Waves App, you will log in using the following information: </p> --}}

                                <p class="lead"><b>Employee ID:</b> {{ $responderId }} </p>
                            ...
                            <p class="lead">Once you select your school and connect to your school’s Waves Network, you will be required to create
                                ...
                                to go. If you're feeling ready, download the app below and jump in. We're glad you're here. </p>
