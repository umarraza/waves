...
<div class="row" style="background-color:#19baff">
        <center>
            <img src="https://www.thewavesapp.online/assets/images/emailHeader.png"
                            ...
                            <p class="lead"><b>Hi {{$firstName}},</b></p>

                            <p class="lead">{{$sessionMessage['message']}}</b></p>

                            <p class="lead">
                                @if($sessionMessage['to']=="responder")
                                    <b>Name of Student: </b>{{$sessionMessage['name']}}<br>
                                @else
                                    <b>Name of Responder: </b>{{$sessionMessage['name']}}<br>
                                @endif
                                <b>Session Date: </b>{{$sessionMessage['date']}}<br>
                                <b>Time: </b>{{$sessionMessage['time']}}<br>
                                <b>Repeats: </b>{{$sessionMessage['repeated']}}<br>
                            </p>
                            @if($sessionMessage['googleLink']!="No")
                                <p class="lead"><a href="{{$sessionMessage['googleLink']}}">Click here</a> to add this session to your Google calendar.</p>
                                <p class="lead"><a href="{{$sessionMessage['outlookLink']}}"download>Click here</a> to add this session to your Outlook calendar.</p>
                            @endif
                            <br>
