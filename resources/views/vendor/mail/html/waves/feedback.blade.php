        ...
        <td class="container" bgcolor="#FFFFFF">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td> --}}
                            <p class="lead"><b>Feedback from a {{$roleName}} 
                            </b></p>
                            <br>
                            {{-- <hr> --}}
                            <br>

                            <p class="lead"><b>Name:</b> {{$name}}<b></b>!

                            </p>

                            <p class="lead"><b>School Name:</b> {{$schoolName}}<b></b>!

                            </p>

                            <p class="lead"><b>Feedback:</b> {{$feedback}}
                            ...
                            {{-- <a style="text-decoration:none;color: #FFF !important;background-color: #16baff;padding:2px 25px;font-weight:bold;margin-right:10px;text-align:center;cursor:pointer;display: inline-block;"
                                target="_blank" href="http://ec2-18-219-131-166.us-east-2.compute.amazonaws.com/waves/">Jump In</a> --}}
         {{--                </td>
                    </tr>
                </table>
            </div>
